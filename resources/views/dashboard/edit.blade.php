...
<div class="card mb-3">
  <form class="row g-0" action="/dashboard/{{ $guru->nis }}" method="post" enctype="multipart/form-data">
    @method('put')
    @csrf
      ...
      <div class="card-body">
        <ul class="list-group list-group-flush mb-3">
          ...
          <li class="list-group-item">
            <div class="row">
              <div class="col-2">
                <label for="oldpw" class="col-form-label fw-bold">Old Password</label>
              </div>
              <div class="col-4">
                <input type="password" id="oldpw" name="oldpw" class="form-control @error('oldpw') is-invalid @enderror">
                @error('oldpw')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              <div class="col-2">
                <label for="newpw" class="col-form-label fw-bold">New Password</label>
              </div>
              <div class="col-4">
                <input type="password" id="newpw" name="newpw" class="form-control @error('newpw') is-invalid @enderror">
                @error('newpw')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
